...
- Do not present AI-performed review or inspection as manual checks. Manual checks should be human-performed. If a
  human asked AI to inspect something, describe the human request first, nest the AI result under it, and clearly label
